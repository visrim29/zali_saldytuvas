...
# Prideda pradinius produktus į šaldytuvą
prideti_produkta(saldytuve, "Sūris", 0.3)
prideti_produkta(saldytuve, "Pomidoras", 2.5)
prideti_produkta(saldytuve, "Duona", 0.5)
